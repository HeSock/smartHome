...
@section('content')
    ...
    <div class="contetn2 show" id="content2">
        <div class="content_sub">
            ...
            @endif
            <div class="table_name">修改渠道名称</div>
            <form action="{{url()->full()}}" method="post" enctype="multipart/form-data"  id="addChannle">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="text" name="channelName" id="channelName" required value="{{ $channel->channel_name }}">
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ url('channelList') }}" class="btn btn-primary" role="button">取消</a>
                        </td>
                    </tr>
                </table>
            </form>
